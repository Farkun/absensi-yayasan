                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="text-center">
                                    <h2 class="mb-1">Selamat Datang, {{ Auth::guard('user')->user()->name }}</h2>
                    ...
                    <div class="card-body gradient-7">
                        <div class="media">
                            ...
                            <div class="media-body">
                                <h2 class="card-widget__title">{{ $rekappresensi->jmlhadir }}</h2>
                ...
                <div class="card card-widget">
                    <div class="card-body gradient-4">
                        <div class="media">
                            ...
                            <div class="media-body">
                                <h2 class="card-widget__title">{{ $rekapizin->jmlizin != null ? $rekapizin->jmlizin : 0 }}
                                </h2>
                    ...
                    <div class="card-body gradient-5">
                        <div class="media">
                            <span class="card-widget__icon"><ion-icon name="medkit-outline"
                                    style="font-size: 35px;"></ion-icon></span>
                            <div class="media-body">
                                <h2 class="card-widget__title">{{ $rekapizin->jmlsakit != null ? $rekapizin->jmlsakit : 0 }}
                                </h2>
                        ...
                        <div class="media">
                            ...
                            <div class="media-body">
                                <h2 class="card-widget__title">
                                    {{ $rekappresensi->jmlterlambat != null ? $rekappresensi->jmlterlambat : 0 }}</h2>
                ...
                <div class="card card-widget">
                    <div class="card-body gradient-3">
                        <div class="media">
                            ...
                            <div class="media-body">
                                <h2 class="card-widget__title">
                                    {{ $rekapizin->jmlcuti != null ? $rekapizin->jmlcuti : 0 }}</h2>

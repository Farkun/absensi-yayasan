...
<div style="height: calc(100vh - 60px); overflow-y: auto;">
    <div class="row" style="margin-top: 70px;">
        <div class="col">
            <form method="POST" action="<?php echo e(route('update_sakit')); ?>" id="frmIzin" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                <input type="hidden" name="id" id="id" value="<?php echo e($izin->id); ?>">
                <div class="form-group">
                    <input type="text" id="tgl_izin_dari" name="tgl_izin_dari" value="<?php echo e($izin->tgl_izin_dari); ?>" class="form-control datepicker" placeholder="Dari">
                </div>
                <div class="form-group">
                    <input type="text" id="tgl_izin_sampai" name="tgl_izin_sampai" value="<?php echo e($izin->tgl_izin_sampai); ?>" class="form-control datepicker" placeholder="Sampai">
                </div>
                <div class="form-group">
                    <input type="text" id="jml_hari" name="jml_hari" class="form-control" placeholder="Jumlah Hari" readonly>
                </div>
                <div class="form-group">
                    <textarea name="keterangan" id="keterangan" cols="30" rows="5" class="form-control" placeholder="Keterangan *maks: 225 karakter"><?php echo e($izin->keterangan); ?></textarea>
                </div>
                <?php if($izin->gambar != null): ?>
                <div class="row">
                    <div class="col-12">
                        <div style="display: flex; align-items: center; gap: 10px;">
                        <img src="<?php echo e(Storage::url($izin->gambar)); ?>" alt="" width="100px" > 
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.attendance', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\attendance-ypb\resources\views/sakit/edit.blade.php ENDPATH**/ ?>
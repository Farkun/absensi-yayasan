...
<head>
    ...
    <link href="<?php echo e(asset('admin/plugins/clockpicker/dist/jquery-clockpicker.min.css')); ?>" rel="stylesheet">
    <link href="<?php echo e(asset('admin/plugins/jquery-asColorPicker-master/css/asColorPicker.css')); ?>" rel="stylesheet">
    <link href="<?php echo e(asset('admin/plugins/bootstrap-material-datetimepicker/css/bootstrap-material-datetimepicker.css')); ?>" rel="stylesheet">
    <link href="<?php echo e(asset('admin/plugins/bootstrap-datepicker/bootstrap-datepicker.min.css')); ?>" rel="stylesheet">
    <link href="<?php echo e(asset('admin/plugins/timepicker/bootstrap-timepicker.min.css')); ?>" rel="stylesheet">
    <link href="<?php echo e(asset('admin/plugins/bootstrap-daterangepicker/daterangepicker.css')); ?>" rel="stylesheet">
    <!-- Custom Stylesheet -->
...
<body>
        ...
        ***********************************-->
        <div class="nav-header">
            <div class="center-logo">
                    ...
                    <span>
                        <img src="<?php echo e(asset('admin/images/LOGO-YPB_BULAT.png')); ?>" alt="" width="65">
                    </span>
            </div>
        </div>
        <!--**********************************
    ...
    ***********************************-->
    ...
    <script src="<?php echo e(asset('admin/plugins/moment/moment.js')); ?>"></script>
    <script src="<?php echo e(asset('admin/plugins/bootstrap-material-datetimepicker/js/bootstrap-material-datetimepicker.js')); ?>"></script>
    <script src="<?php echo e(asset('admin/plugins/clockpicker/dist/jquery-clockpicker.min.js')); ?>"></script>
    <script src="<?php echo e(asset('admin/plugins/jquery-asColorPicker-master/libs/jquery-asColor.js')); ?>"></script>
    <script src="<?php echo e(asset('admin/plugins/jquery-asColorPicker-master/libs/jquery-asGradient.js')); ?>"></script>
    <script src="<?php echo e(asset('admin/plugins/jquery-asColorPicker-master/dist/jquery-asColorPicker.min.js')); ?>"></script>
    <script src="<?php echo e(asset('admin/plugins/bootstrap-datepicker/bootstrap-datepicker.min.js')); ?>"></script>
    <script src="<?php echo e(asset('admin/plugins/timepicker/bootstrap-timepicker.min.js')); ?>"></script>
    <script src="<?php echo e(asset('admin/plugins/bootstrap-daterangepicker/daterangepicker.js')); ?>"></script>

    <script src="<?php echo e(asset('admin/js/plugins-init/form-pickers-init.js')); ?>"></script>
...
<?php /**PATH C:\xampp\htdocs\BHF\absensi-yayasan\resources\views/layouts/admin/admin.blade.php ENDPATH**/ ?>
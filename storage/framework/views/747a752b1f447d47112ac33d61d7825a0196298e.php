            ...
            <form method="POST" action="/izincuti/store" id="frmIzin" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <select name="kode_cuti" id="kode_cuti" class="form-control">
                        ...
                        <option value="<?php echo e($c->kode_cuti); ?>"><?php echo e($c->nama_cuti); ?></option>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.attendance', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\attendance-ypb\resources\views/izincuti/create.blade.php ENDPATH**/ ?>
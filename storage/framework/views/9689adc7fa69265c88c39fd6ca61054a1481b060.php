                ...
                <div class="col-xl-6">
                    <div class="form-input-content">
                        <div class="card login-form mb-0">
                            ...
                            <img src="<?php echo e(asset('admin/images/LOGO-YPB_BULAT.png')); ?>" alt="" style="width: 250px; height: 250px; margin-left: 118px">
                            <?php if(Session::get('warning')): ?>
                            <div class="alert alert-warning">
                                <p><?php echo e(Session::get('warning')); ?></p>
                            </div>
                            <?php endif; ?>
                                <form action="/loginadmin" method="POST" class="mt-5 mb-5 login-input">
                                    <?php echo csrf_field(); ?>
                                    ...
                                    <button class="btn btn-success submit w-100">Sign In</button>
                                </form>
...
<?php /**PATH C:\xampp\htdocs\BHF\absensi-yayasan\resources\views/auth/loginadmin.blade.php ENDPATH**/ ?>